...
#define mxml_malloc(n) HeapAlloc(GetProcessHeap(), 0, n)
#define mxml_calloc(m, n) HeapAlloc(GetProcessHeap(), HEAP_ZERO_MEMORY, m * n)
#define mxml_realloc(p, n) HeapReAlloc(GetProcessHeap(), 0, p, n)
#define mxml_free(p) HeapFree(GetProcessHeap(), 0, p)
...
extern const char	*mxmlElementGetAttr2(mxml_node_t *node, const char *name);
